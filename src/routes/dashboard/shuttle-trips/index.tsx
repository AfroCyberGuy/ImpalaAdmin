...
function ShuttleTrips() {
  const {
    ...
    isLoading,
    error,
  } = useQuery(shuttleTripsQueryOptions);
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Shuttle Trips</h1>
...
function TripRow({ trip }: { trip: ShuttleTrip }) {
  return (
    <tr className="hover:bg-gray-50/70 transition-colors group">
      ...
      <td className="px-5 py-3.5 text-right whitespace-nowrap">
        <Link
          to="/dashboard/shuttle-trips/$tripId"
